...
int main(int argc, char **argv)
{
  if(argc!=2)
  {
    std::cout << "to run type: ./open_fitparams.o path/to/logfile.txt" << std::endl;
    return 0;
  }
  ...
  while(log.good())
  {
   ...
   std::cout << "\n\nRUN PRELIMINARY ANALYSIS" <<std::endl;
   char command_3[500] = "kate ";
   strcat(command_3, meas_path.c_str());
   strcat(command_3, "fitparams.out &");
